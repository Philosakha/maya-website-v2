...
export default function Sidebar(){
    ...
    const openSidebar = () => {
        document.querySelector("#mobile-sidebar").classNameList.toggle("hidden");
    }
      ...
      <Link href="/"><li classNameName='border-b flex items-center p-2 text-gray-900  dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group'>
         ...
         <Link href="/QuickStart"><li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="ml-3">QuickStart</span>
            </a>
         </li></Link>
         <Link href="/Intro-to-cosmos"><li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               < GiGalaxy />
               <span className="ml-3">Intro to Cosmos</span>
         ...
         <Link href="/Intro-to-wormhole" ><li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               < GiBlackHoleBolas />
               <span className="flex-1 ml-3 whitespace-nowrap">Intro to Wormhole</span>
            </a>
         </li></Link>
         <Link href="Intro-to-Gateway" ><li>
            ...
            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
               ...
               <span className="flex-1 ml-3 whitespace-nowrap">Intro to Gateway</span>
            </a>
         </li></Link>
         <Link href="Gateway-architecture"><li>
            ...
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <MdArchitecture />
               <span className="flex-1 ml-3 whitespace-nowrap">Gateway Architecture</span>
            </a>
         ...
         <Link href="/Security-Aspects"><li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <MdOutlineSecurity />
               <span className="flex-1 ml-3 whitespace-nowrap">Security Aspects</span>
            </a>
         </li></Link>
